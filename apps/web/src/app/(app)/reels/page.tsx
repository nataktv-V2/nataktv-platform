    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
        ...
        <div className="shiny-border inline-block">
          <Link
            href="/subscribe"
            className="inline-flex flex-col items-center leading-tight bg-accent hover:bg-accent-hover text-white px-8 py-3 rounded-[14px] font-semibold transition-colors"
          >
